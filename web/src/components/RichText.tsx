...
const PROSE = [
  ...
  '[&_p]:my-5',
  '[&_h2]:mt-12 [&_h2]:mb-4 [&_h2]:text-2xl md:[&_h2]:text-3xl [&_h2]:font-bold [&_h2]:text-ink [&_h2]:leading-tight',
  '[&_h3]:mt-9 [&_h3]:mb-3 [&_h3]:text-xl md:[&_h3]:text-2xl [&_h3]:font-bold [&_h3]:text-brand-link',
