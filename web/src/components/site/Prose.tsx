...
export const STANDFIRST_CLASSES = 'text-lg leading-relaxed font-semibold text-ink md:text-xl'
...
export const PROSE_CLASSES = [
  ...
  '[&_h3]:mt-8 md:[&_h3]:mt-10 [&_h3]:mb-3 [&_h3]:text-xl md:[&_h3]:text-2xl [&_h3]:font-bold [&_h3]:text-ink [&_h3]:text-balance',
  '[&_h4]:mt-6 md:[&_h4]:mt-8 [&_h4]:mb-2 [&_h4]:text-lg md:[&_h4]:text-xl [&_h4]:font-semibold [&_h4]:text-ink',
  '[&_:is(h2,h3,h4)+:is(h2,h3,h4)]:mt-4',
  '[&_ul]:mt-2 [&_ul]:mb-8 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:mt-2 [&_ol]:mb-8 [&_ol]:list-decimal [&_ol]:pl-6',
  '[&_li+li]:mt-4',
  '[&_dl]:my-6 [&_dl]:grid [&_dl]:grid-cols-[fit-content(10rem)_1fr] [&_dl]:gap-x-6 [&_dl]:gap-y-2 [&_dl]:rounded-lg [&_dl]:border [&_dl]:border-line [&_dl]:px-5 [&_dl]:py-4',
  '[&_dt]:font-bold [&_dt]:text-ink [&_dd]:text-body',
